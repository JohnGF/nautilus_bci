% gHIampGetScalingDemo is a MATLAB script demonstrating how to read scaling
% values of g.HIamp in g.NEEDaccess MATLAB API.
...
% return scaling for connected g.HIamp
ghiamp_scaling = gds_interface.GetScaling();
