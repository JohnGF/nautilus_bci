% gUSBampAPIImpedanceDemo is a MATLAB script demonstrating how impedance
% measurement works in g.NEEDaccess MATLAB API using g.USBamp.
...
% return impedances for selected channels. GetImpedance function used with
% g.USBamp requires the serial number of the device to be measured as
% input. The variable returned contains a 2 x channels array representing
% measured channel and corresponding impedance
impedances = gds_interface.GetImpedance(gusbamp_config.Name, channel_selected);
