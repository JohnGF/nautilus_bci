...
% signal (+/- 200mV, 10Hz) for 10 seconds and plots one channel of the
% acquired data offline after recording.
...
% record data for 10 seconds and plot the first analog channel acquired.
samples_acquired = 0;
